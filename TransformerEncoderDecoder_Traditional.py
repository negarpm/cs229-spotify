...
#         print("inside the custom")
        self.self_attn = nn.MultiheadAttention(d_model, nhead, dropout=dropout, kdim=68, vdim=68)
...
class TransformerModel(nn.Module):
    ...
    def __init__(self, nlabels, n_input1, n_input2, nhead, nhid, nlayers, dropout=0.5, kdim=68, vdim=68):
        ...
        decoder_layer = TransformerDecoderLayer(n_input1, nhead, nhid, dropout) ##, 30, 68)
...
#         out = transformer_decoder(tgt, memory)
        ...
        self.final_linear = nn.Linear(self.n_input1, nlabels, bias=True)
